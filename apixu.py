#!/usr/bin/env python3
"""
Polyglot v2 node server Apixu.com weather data
...
class Controller(polyinterface.Controller):
    ...
    def start(self):
        ...
        for day in range(1,7):
            ...
            try:
                node = apixu_daily.DailyNode(self, self.address, address, title)
                self.addNode(node);
            except:
    ...
    def query_conditions(self, force):
        ...
        request = 'https://api.apixu.com/v1/current.json?'
        ...
        #  condition URL http://www.apixu.com/doc/Apixu_weather_conditions.json
...
if __name__ == "__main__":
    try:
        polyglot = polyinterface.Interface('APIXU')
        polyglot.start()
